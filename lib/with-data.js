...
const PER_DAY = 1000
const KNOCK_OUT_PER_DAY = 9000
const START_DAY = moment('2018-06-13T00:00:00+08:00')
const KNOCK_OUT_START_DAY = moment('2018-06-29T00:00:00+08:00')
...
const getInitial = (now) => {
  let initial = 0
  const fromStart = now.diff(START_DAY, 'd')
  initial += PER_DAY * now.diff(START_DAY, 'd') +
  KNOCK_OUT_PER_DAY * now.diff(KNOCK_OUT_START_DAY, 'd')
  return initial
}
...
export const getBalance = ({
  ...
  initial = initial === undefined ? getInitial(now) : initial
